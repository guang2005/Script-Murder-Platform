...
import static com.jq.utils.RedisConstants.BLOG_LIKED_KEY;
import static com.jq.utils.RedisConstants.FEED_KEY;
...
@Service
public class
BlogServiceImpl extends ServiceImpl<BlogMapper, Blog> implements IBlogService {
    @Resource
    ...
    @Override
    public Result queryBlogById(Long id) {//根据id查询笔记
        //1.查询blog
